...
import ZoomParallax from "@/app/(routes)/(marketing)/about/_components/ZoomParallax";
import AboutUsContent from "@/app/(routes)/(marketing)/about/_components/AboutUsContent";
