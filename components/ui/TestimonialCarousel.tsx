...
export default function TestimonialItems({
  ...
  return (
    <div className='w-full relative'>
      <h2 className="relative text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-20 text-center after:content-[''] after:absolute after:left-1/2 after:bottom-[-10px] after:transform after:-translate-x-1/2 after:w-20 after:h-1 after:bg-warning-600 bg-success text-white">
        {title}
      </h2>
      <button
