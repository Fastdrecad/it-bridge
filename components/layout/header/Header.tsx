...
function Header() {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`z-30 sticky top-0 h-[var(--header-height)] w-full transition-all duration-300 transform ${
          isVisible ? 'translate-y-0' : '-translate-y-full'
        } ${bgStyle}`}
      >
        <div className='container h-full mx-auto px-3 sm:px-4 lg:px-6'>
          <div className='flex justify-between sm:items-center mx-auto py-2 relative z-0 h-full'>
